...
@section('content')
    ...
    <form method="POST" action="/channel/{{$id}}">@csrf
    <div class="container text-center">
        <div class="jumbotron ">
            <h2>Choose the <strong>Channels</strong>  Affected by this Request</h2><br>
            <div class="container-fluid " id="content">
                <div class="row justify-content-center  animated fadeInLeft  ">
                    <div class="col-md-4 col-lg-4 col-xl-4 col-sm-4 p-4  " >
                        <h5 class="">Available Channels</h5>

                        <select style="height:200px; width: 80%; border-radius: 7px; font-family: Arial, Helvetica, sans-serif; " multiple="" id="list1">
                            @foreach(App\Channels::all() as $channel)
                                <option style="margin-top: 10px; margin-left: 5px; font-family: 'Patua One', cursive;" value="{{$channel->id}}">{{$channel->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 col-lg-4 col-xl-4 col-sm-4 p-4  ">
                        <h5 class="">Selected Channels</h5>
                        <select class="" style="height:200px; width: 80%; border-radius: 10px; font-family: Arial, Helvetica, sans-serif;" multiple="" id="list2" name="selectedChannel[]">
                        </select>
        ...
        <a href="/audience/{{$id}}" class="btn btn-primary btn-lg">Back to audience</a>
